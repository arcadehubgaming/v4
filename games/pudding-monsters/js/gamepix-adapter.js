!function n(e, t, r) {
  ...
  7: [function(n, e, t) {
      ...
      e.exports = function(n, e, t) {
          for (var r = a(n), c = i(e, r), u = i(void 0 === t ? r : t, r), p = s(l(u - c, 0)), f = 0; c < u; c++,
          f++)
              o(p, f, n[c]);
          return p.length = f,
          p
      ...
      var r = n("../internals/array-slice-simple")
        ...
        , s = function(n, e, t, r) {
          for (var i = e.length, a = t.length, o = 0, s = 0; o < i || s < a; )
              n[o + s] = o < i && s < a ? r(e[o], t[s]) <= 0 ? e[o++] : t[s++] : o < i ? e[o++] : t[s++];
          return n
      };
      e.exports = a
  }
  ...
  17: [function(n, e, t) {
      ...
      e.exports = function(n, e, t, o, y, h, E) {
          ...
          }, T = e + " Iterator", P = !1, I = n.prototype, C = I[j] || I["@@iterator"] || y && I[y], N = !w && C || A(y), M = "Array" == e && I.entries || C;
          if (M && (L = c(M.call(new n))) !== Object.prototype && L.next && (a || c(L) === m || (u ? u(L, m) : s(L[j]) || b(L, j, O)),
          p(L, T, !0, !0),
          a && (d[T] = O)),
          g && y == k && C && C.name !== k && (!a && v ? f(I, "name", k) : (P = !0,
          N = function() {
              return i(C, this)
          }
          )),
  ...
  , {
      "../internals/engine-user-agent": 22,
      "../internals/global": 36
  }],
  24: [function(n, e, t) {
  ...
  25: [function(n, e, t) {
      ...
      e.exports = function(n, e) {
          var t, u, p, f, b, y = n.target, d = n.global, h = n.stat;
  ...
  33: [function(n, e, t) {
      ...
      e.exports = function(n) {
          if (null != n)
              return i(n, o) || i(n, "@@iterator") || a[r(n)]
      }
  }
  , {
  ...
  43: [function(n, e, t) {
      var r, i, a, o = n("../internals/native-weak-map"), s = n("../internals/global"), l = n("../internals/function-uncurry-this"), c = n("../internals/is-object"), u = n("../internals/create-non-enumerable-property"), p = n("../internals/has-own-property"), f = n("../internals/shared-store"), b = n("../internals/shared-key"), y = n("../internals/hidden-keys"), d = "Object already initialized", h = s.TypeError, g = s.WeakMap;
      if (o || f.state) {
  ...
  49: [function(n, e, t) {
      "use strict";
      var r, i, a, o = n("../internals/fails"), s = n("../internals/is-callable"), l = n("../internals/object-create"), c = n("../internals/object-get-prototype-of"), u = n("../internals/redefine"), p = n("../internals/well-known-symbol"), f = n("../internals/is-pure"), b = p("iterator"), y = !1;
      [].keys && ("next"in (a = [].keys()) ? (i = c(c(a))) !== Object.prototype && (r = i) : y = !0),
      null == r || o((function() {
          var n = {};
          return r[b].call(n) !== n
      }
      )) ? r = {} : f && (r = l(r)),
      s(r[b]) || u(r, b, (function() {
          return this
      }
      )),
      e.exports = {
  ...
  , {
      "../internals/engine-v8-version": 23,
      "../internals/fails": 26
  }],
  53: [function(n, e, t) {
      var r = n("../internals/fails")
      ...
      e.exports = !r((function() {
          var n = new URL("b?a=1&b=2&c=3","http://a")
            , e = n.searchParams
            , t = "";
          return n.pathname = "c%20d",
          e.forEach((function(n, r) {
              e.delete("b"),
              t += r + n
          }
          )),
          a && !n.toJSON || !e.sort || "http://a/c%20d?a=1&c=3" !== n.href || "3" !== e.get("c") || "a=1" !== String(new URLSearchParams("?a=1")) || !e[o] || "a" !== new URL("https://a@b").username || "b" !== new URLSearchParams(new URLSearchParams("a=b")).get("a") || "xn--e1aybc" !== new URL("http://тест").host || "#%D0%B1" !== new URL("http://a#б").hash || "a1c3" !== t || "x" !== new URL("http://x",void 0).host
      }
      ))
  }
  , {
  ...
  55: [function(n, e, t) {
      var r, i = n("../internals/an-object"), a = n("../internals/object-define-properties"), o = n("../internals/enum-bug-keys"), s = n("../internals/hidden-keys"), l = n("../internals/html"), c = n("../internals/document-create-element"), u = n("../internals/shared-key"), p = u("IE_PROTO"), f = function() {}, b = function(n) {
          ...
          var n, e;
          d = "undefined" != typeof document ? document.domain && r ? y(r) : ((e = c("iframe")).style.display = "none",
          l.appendChild(e),
          ...
          for (var t = o.length; t--; )
              delete d.prototype[o[t]];
          return d()
      };
      s[p] = !0,
      e.exports = Object.create || function(n, e) {
          var t;
          return null !== n ? (f.prototype = i(n),
          t = new f,
          f.prototype = null,
          t[p] = n) : t = d(),
          void 0 === e ? t : a.f(t, e)
  ...
  57: [function(n, e, t) {
      ...
      t.f = i ? o ? function(n, e, t) {
          ...
          e = l(e),
          s(t),
          "function" == typeof n && "prototype" === e && "value"in t && y in t && !t.writable) {
              var r = p(n, e);
  ...
  61: [function(n, e, t) {
      var r = n("../internals/global")
        ...
        , u = r.Object
        , p = u.prototype;
      e.exports = l ? u.getPrototypeOf : function(n) {
          var e = o(n);
          if (i(e, c))
              return e[c];
          var t = e.constructor;
          return a(t) && e instanceof t ? t.prototype : e instanceof u ? p : null
      }
  }
  , {
  ...
  70: [function(n, e, t) {
      ...
      (e.exports = function(n, e, t, l) {
          var c, p = !!l && !!l.unsafe, y = !!l && !!l.enumerable, d = !!l && !!l.noTargetGet, h = l && void 0 !== l.name ? l.name : e;
          i(t) && ("Symbol(" === String(h).slice(0, 7) && (h = "[" + String(h).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"),
          (!a(t, "name") || u && t.name !== h) && o(t, "name", h),
          (c = f(t)).source || (c.source = b.join("string" == typeof h ? h : ""))),
          n !== r ? (p ? !d && n[e] && (y = !0) : delete n[e],
          y ? n[e] = t : o(n, e, t)) : y ? n[e] = t : s(e, t)
      }
  ...
  92: [function(n, e, t) {
      ...
      var r = n("../internals/to-indexed-object")
        ...
        , f = o.set
        , b = o.getterFor(p);
      e.exports = l(Array, "Array", (function(n, e) {
          f(this, {
              type: p,
              target: r(n),
              index: 0,
  ...
  94: [function(n, e, t) {
      ...
      var r = n("../internals/export")
        ...
        , Z = Array(4)
        , nn = function(n) {
          return Z[n - 1] || (Z[n - 1] = F("((?:%[\\da-f]{2}){" + n + "})", "gi"))
      }
        , en = function(n) {
          try {
              return W(n)
        ...
        , ln = f((function(n, e) {
          ...
          var n = C(this)
            ...
            , t = n.iterator.next()
            , r = t.value;
          return t.done || (t.value = "keys" === e ? r.key : "values" === e ? r.value : [r.key, r.value]),
          t
      }
      ), !0)
        , cn = function(n) {
          this.entries = [],
          this.url = null,
          void 0 !== n && (w(n) ? this.parseObject(n) : this.parseQuery("string" == typeof n ? "?" === q(n, 0) ? K(n, 1) : n : j(n)))
      };
      cn.prototype = {
          type: A,
          bindURL: function(n) {
          ...
          parseObject: function(n) {
              var e, t, r, i, a, s, l, c = O(n);
              if (c)
                  for (t = (e = S(n, c)).next; !(r = o(t, e)).done; ) {
                      if (a = (i = S(m(r.value))).next,
      ...
      if (u(pn, {
          ...
          delete: function(n) {
              ...
              for (var e = I(this), t = e.entries, r = j(n), i = 0; i < t.length; )
                  t[i].key === r ? X(t, i, 1) : i++;
              e.updateURL()
          },
          get: function(n) {
              E(arguments.length, 1);
              for (var e = I(this).entries, t = j(n), r = 0; r < e.length; r++)
                  if (e[r].key === t)
                      return e[r].value;
              return null
          },
          getAll: function(n) {
              E(arguments.length, 1);
              for (var e = I(this).entries, t = j(n), r = [], i = 0; i < e.length; i++)
          ...
          set: function(n, e) {
              E(arguments.length, 1);
              for (var t, r = I(this), i = r.entries, a = !1, o = j(n), s = j(e), l = 0; l < i.length; l++)
                  (t = i[l]).key === o && (a ? X(i, l--, 1) : (a = !0,
                  t.value = s));
              a || B(i, {
                  key: o,
                  value: s
          ...
          forEach: function(n) {
              for (var e, t = I(this).entries, r = g(n, arguments.length > 1 ? arguments[1] : void 0), i = 0; i < t.length; )
          ...
          var fn = s(G.has)
            ...
            , yn = function(n) {
              if (w(n)) {
                  var e, t = n.body;
                  if (v(t) === A)
                      return e = n.headers ? new U(n.headers) : new U,
                      fn(e, "content-type") || bn(e, "content-type", "application/x-www-form-urlencoded;charset=UTF-8"),
                      x(n, {
                          body: k(0, j(t)),
                          headers: k(0, e)
                      })
  ...
  96: [function(n, e, t) {
      ...
      class a {
          constructor(n) {
              if (r(this, "sdk", void 0),
              r(this, "gamepixSdk", void 0),
              this.sdk = n,
              this.gamepixSdk = window.GamePix,
              void 0 === this.sdk)
                  throw new Error("Can't use GamepixAdapter without defined porting sdk");
              this.sdk.metrics.push("gamepixSdkUndefined", void 0 === this.gamepixSdk ? 1 : 0),
              void 0 !== this.gamepixSdk && void 0 === this.gamepixSdk.CONST && (this.gamepixSdk.CONST = i),
              this.sdk.module.ready = this.ready.bind(this),
              this.sdk.module.ping = this.ping.bind(this)
          }
          ready(n) {
              const e = []
                , t = void 0 === this.gamepixSdk ? window.navigator.language.slice(0, 2) : this.gamepixSdk.lang();
              e.push(t);
          ...
          ping(n, e) {
              void 0 !== this.gamepixSdk && void 0 !== this.gamepixSdk.ping && this.gamepixSdk.ping(n, e)
          }
          hook(n, e, t, r) {
              if (void 0 !== this.gamepixSdk)
                  switch (n) {
                  case i.SHOW_VIDEO_REWARD:
                      this.gamepixSdk.rewardAd().then((n=>{
                          n.success ? t() : r()
                      }
                      )).catch(r);
                      break;
                  case i.SHOW_INTERSTITIAL:
                      this.gamepixSdk.interstitialAd().then((n=>{
                          n.success ? t() : r()
                      }
                      )).catch(r);
                      break;
                  default:
                      void 0 !== this.gamepixSdk.hook && this.gamepixSdk.hook(n, e, t, r)
                  }
          }
      }
      t.GamepixAdapter = a;
      const o = window.tinyLoader;
      void 0 !== o && (o.run.push((async()=>{
